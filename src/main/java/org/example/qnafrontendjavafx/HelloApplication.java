...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) {
        ...
        final var signInPage = SignInPage.getPage(eventBus);
        final var pageRegistry = new ApplicationPageRegistry(generalUserSignUpPage, expertUserSignUpPage, signInPage);
